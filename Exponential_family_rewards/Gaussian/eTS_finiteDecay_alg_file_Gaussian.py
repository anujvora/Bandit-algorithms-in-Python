...
def eTS_finiteDecay_alg(arms,seed_val,hori):
    ...
    while curr_time < hori:
        ...
        if bet_samp == 0:
            ...
            # mu_post = (times_sampled*mean_par + 1)/(times_sampled*1 + 1) #(times_sampled*1/(times_sampled*1 + 1))*mean_par[:] + 1/(times_sampled*1 + 1)
